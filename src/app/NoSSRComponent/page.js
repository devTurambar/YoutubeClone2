...
async function getApi() {
  ...
  const YOUTUBE_PLAYLIST_ITEMS_API = "https://www.googleapis.com/youtube/v3/playlistItems";
    try {
      const response = await axios.get(`${YOUTUBE_PLAYLIST_ITEMS_API}?part=snippet&playlistId=PLLyHBx6FRJC3BymwVJUiHN-eDXgZoqLQc&maxResults=50&key=${process.env.YOUTUBE_API_KEY}`);
      console.log("HELLO");
